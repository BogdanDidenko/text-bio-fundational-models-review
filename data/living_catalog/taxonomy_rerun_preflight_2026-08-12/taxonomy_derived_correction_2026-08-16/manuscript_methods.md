...
The full_living_catalog_55_records comprised 55 accepted screening records represented
by complete VLM-enriched Docling profiles. The complete cumulative cohort was
reclassified against the unchanged taxonomy v1; this run did not
re-synthesize or revise the taxonomy.
The registry contained 1 exact source-document duplicate
...
Its 595 candidates formed the fixed route inventory for
...
The final corpus contained 586 accepted input routes across
109 models and
468 configurations.
The minimum pairwise route-detection Jaccard was 0.937;
carrier-family exact agreement was 0.925,
and nominal Krippendorff alpha was 0.881.
All 2893 dense candidates were dispositioned, with
68 accepted as dense-only evidence and 2 retained as
