...
Qihao Duan 1,4,5 , Bingding Huang 2 , Zhenqiao Song 3 ,
...
Berlin Institute of Health, Charité - Universitätsmedizin Berlin 2 College of Big Data and Internet, Shenzhen Technology University 3 Language Technologies Institute, Carnegie Mellon University
...
6 Health Data Science Unit, Heidelberg University Hospital and BioQuant 7 Intelligent Medicine Institute, Fudan University †

Corresponding authors

benjamin.wild}@bih-charite.de

{qihao.duan, irina.lehmann, roland.eils, huangbingding@sztu.edu.cn zhenqias@andrew.cmu.edu lei.gu@mpi-bn.mpg.de
...
Both models were trained on the human reference genome (HG38) [32] for 10,000 steps. Each training sample had a context length of 131,072 tokens, processed with a batch size of 1. We evaluated performance across three hidden dimensions: 32, 64, and 128, keeping other hyperparameters consistent. Pre-training for Janus models, benefited from their sparse attention masks, takes around 27 minutes per 1,000 steps, nearly twice as fast as masked models.
...
| H3K4ME3                | 0 . 158 ± 0 . 072 0 . 352 ± 0 . 077 0 . 410 ± 0 . 033 0 | 0 . 158 ± 0 . 072 0 . 352 ± 0 . 077 0 . 410 ± 0 . 033 0 | 0 . 158 ± 0 . 072 0 . 352 ± 0 . 077 0 . 410 ± 0 . 033 0 | . 549 ± 0 . 056                | 0 . 544 ± 0 . 045              | 0 . 566 ± 0 . 027 0 .          | 688 ± 0 . 026 0                  | . 675 ± 0 . 014                   |
...
- [40] Michael Poli, Stefano Massaroli, Eric Nguyen, Daniel Y Fu, Tri Dao, Stephen Baccus, Yoshua Bengio, Stefano Ermon, and Christopher Ré. Hyena hierarchy: Towards larger convolutional language models. In International Conference on Machine Learning , pages 28043-28078. PMLR, 2023.
- [41] Badri Narayana Patro and Vijay Srinivas Agneeswaran. Mamba-360: Survey of state space models as transformer alternative for long sequence modelling: Methods, applications, and challenges. arXiv preprint arXiv:2404.16112 , 2024.
- [42] Mingqian Ma, Guoqing Liu, Chuan Cao, Pan Deng, Tri Dao, Albert Gu, Peiran Jin, Zhao Yang, Yingce Xia, Renqian Luo, et al. Hybridna: A hybrid transformer-mamba2 long-range dna language model. arXiv preprint arXiv:2502.10807 , 2025.
...
| ENHANCER               | 0 . 564 ± 0 . 022               | 0 . 535 ± 0 . 036               | 0 . 559 ± 0 . 042                  | 0 . 542 ± 0 . 044                   |
| ENHANCER TYPES         | 0 . 462 ± 0 . 049               | 0 . 470 ± 0 . 025               | 0 . 503 ± 0 . 038                  | 0 . 492 ± 0 . 096                   |
| PROMOTER: ALL          | 0 . 969 ± 0 . 002               | 0 . 971 ± 0 . 002               | 0 . 970 ± 0 . 002                  | 0 . 970 ± 0 . 003                   |
| NONTATA                | 0 . 971 ± 0 . 003               | 0 . 971 ± 0 . 002               | 0 . 971 ± 0 . 004                  | 0 . 971 ± 0 . 003                   |
| TATA                   | 0 . 956 ± 0 . 010               | 0 . 958 ± 0 . 008               | 0 . 958 ± 0 . 007                  | 0 . 960 ± 0 . 008                   |
| Splice Site Annotation | Splice Site Annotation          | Splice Site Annotation          | Splice Site Annotation             | Splice Site Annotation              |
| ALL                    | 0 . 963 ± 0 . 022               | 0 . 960 ± 0 . 009               | 0 . 967 ± 0 . 005                  | 0 . 943 ± 0 . 020                   |
...
| OPTIMIZER OPTIMIZER                                    |                                                        | ADAMW                                                  | ADAMW                 | ADAMW                 | ADAMW                 |
| MOMENTUM                                               |                                                        | β 1 , β 2 = 0.9, 0.95                                  | β 1 , β 2 = 0.9, 0.95 | β 1 , β 2 = 0.9, 0.95 | β 1 , β 2 = 0.9, 0.95 |
