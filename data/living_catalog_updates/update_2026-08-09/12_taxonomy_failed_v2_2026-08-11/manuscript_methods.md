...
The final corpus contained 17 accepted input routes across
3 models and
16 configurations.
The minimum pairwise route-detection Jaccard was 1.000;
carrier-family exact agreement was 0.733,
and nominal Krippendorff alpha was 0.546.
All 72 dense candidates were dispositioned, with
2 accepted as dense-only evidence and no unresolved dense candidates.
