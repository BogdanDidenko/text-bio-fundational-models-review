...
This incremental post-eligibility cohort comprised 1 newly accepted
...
descriptions. Its 12 candidates formed the fixed inventory
for this update.
...
The final corpus contained 14 accepted input routes across
3 models and
10 configurations.
The minimum pairwise route-detection Jaccard was 0.750;
carrier-family exact agreement was 1.000,
and nominal Krippendorff alpha was 1.000.
All 96 dense candidates were dispositioned, with
3 accepted as dense-only evidence and no unresolved dense candidates.
